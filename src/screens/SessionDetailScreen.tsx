...
interface SessionDetailScreenProps {
  ...
  onBack: () => void;
  onCompleteSession: (payload: { completedCount: number; totalCount: number; adherenceScore: number; clientNotes: string }) => void;
}

export default function SessionDetailScreen({ session, userInitials, completedExercises, onToggleExercise, onBack, onCompleteSession }: SessionDetailScreenProps) {
  ...
  const handleComplete = () => {
    ...
    onCompleteSession({ completedCount, totalCount, adherenceScore, clientNotes: clientNote });
  };
