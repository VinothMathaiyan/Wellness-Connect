...
export default function AssessmentBookingScreen() {
  ...
  return (
    <OnboardingLayout
      ...
      footer={
        <Button
          onClick={() =>  { handleAssessmentBookingConfirm({ ...{} as any,  status: "scheduled", trainerId: "mock-trainer", scheduled_at: new Date().toISOString(), notes: "" }); navigate("/onboarding/ready"); } }
        >
          Confirm & finish
        </Button>
      }
